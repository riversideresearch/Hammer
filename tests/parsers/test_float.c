...
void register_floating_point_parser_tests(void) {
    ...
    /*
    g_test_add_data_func("/core/parser/float/decimal_float", GINT_TO_POINTER(PB_PACKRAT), test_decimal_float);
    g_test_add_data_func("/core/parser/float/decimal_double", GINT_TO_POINTER(PB_PACKRAT), test_decimal_double);
    */
}
